...
- Develop the software needed to operate an open-learning ecosystem via [`git4ol-services`](//github.com/open-learning/git4ol-services)
- Operate the services and infrastructure needed to provide an public open-learning ecosystem via the [open-learning campus](//github.com/open-learning/campus)
...
- [`git4ol-services`](//github.com/open-learning/git4ol-services)
